...
const WHATSAPP_MESSAGE = encodeURIComponent(
  "Hola! Me gustaría recibir asesoría personalizada para elegir mi fragancia ideal."
);
      ...
      >
        ...
        <AnimatedSection animation="fade-up" delay={0.2}>
          <p className="text-[var(--color-ink-soft)] max-w-md mx-auto mb-8">
            Te asesoramos de forma personalizada. Cuéntanos qué te gusta, cómo quieres
